...
dbc.Row([html.P(dcc.Link("Projections on removal of lockdown",href="https://sars-covid-tracker-india.herokuapp.com/lockdown",target="_blank",style={'color':'#9E12D6',"font-size":"20px"}))]),
